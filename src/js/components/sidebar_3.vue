    ...
    <div class="sidebar" style="background-image: url(images/sidebar.png);">
        ...
        <div class="normal-pic">  
            ...
            <div v-if="item_has_data">
                ...
                <p class="title">
                    <span class="body-2 font-weight-bold color-blue pseudo-link" @click.native="set_scorecard_state()">ScoreCard</span>
                </p>
...
import display_picVue from './display_pic.vue';
  export default {
    ...
    methods: {
        ...
        input_dolist: function(item){
            this.change_component('Select' + item.key + '_' + this.item_param[item.param])
            console.log('a')
